    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Mithlesh sharma - a passionate developer, avid writer,
          and a connoisseur of awesome design. Welcome to my corner of the
          digital world!
        </Paragraph>
        <Paragraph className=" mt-4">
        I am a dedicated BTech graduate with a strong passion for technology, innovation, and building scalable web applications. With expertise in the MERN (MongoDB, Express.js, React.js, Node.js) stack, I specialize in crafting efficient, high-performance solutions. My deep understanding of Data Structures and Algorithms (DSA) enables me to write optimized code, solving complex problems effectively. I believe in continuous learning and mastering core concepts to develop software that is both robust and scalable.
        </Paragraph>

        <Paragraph className=" mt-4">
        Beyond academics, I have one year of experience as an intern at EssayChecker, where I honed my skills in full-stack development and gained hands-on exposure to real-world projects. I actively engage in coding challenges, explore emerging technologies, and contribute to open-source projects, fostering my growth as a developer. Passionate about building impactful software, I thrive in collaborative environments and am always eager to take on new challenges that push the boundaries of innovation
        </Paragraph>
