...
},
  {
    ...
    content: (
      <div>
        ...
        <p>
          ⚡ To optimize performance, the app implements <strong>lazy loading</strong> and <strong>code splitting</strong>, reducing the initial page load time by <strong>40%</strong>. This ensures that only the necessary components are loaded when needed, improving the overall user experience. Additionally, I used <strong>custom hooks</strong> like <strong>useOnline</strong> to check the user's internet connectivity and display appropriate UI feedback, enhancing reliability.
        </p>
        <p>
          🛠️ The app also integrates <strong>Shimmer UI</strong> to enhance the loading experience, making it feel faster and more responsive. By employing <strong>memoization</strong> and <strong>efficient state management</strong>, the app's responsiveness was improved by <strong>40%</strong>, ensuring smooth interactions even on slower networks. These optimizations, combined with dynamic data fetching, resulted in a <strong>Lighthouse score of 93+</strong>.
        </p>
        <p>
          🔑 Key features include:
          <ul>
